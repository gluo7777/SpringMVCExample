...
public class AppTest {
    ...
    public void test_get_all() throws Exception {
        ...
        List<Account> accounts = Arrays.asList(
                new Account("willk777","1234"),
                new Account("willk888","abcd")
        );
    ...
    public void test_get_by_id() throws Exception {
        Account account = new Account("willk777","1234");
    ...
    public void test_create_user_success() throws Exception {
        ...
        when(accountService.exists(account)).thenReturn(false);
        ...
        verify(accountService, times(1)).exists(account);
    ...
    public void test_update_user_success() throws Exception {
        ...
        when(accountService.exists(account)).thenReturn(true);
